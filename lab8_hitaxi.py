...
def remove_duplicates_set(s):
    """
    Removes duplicate characters from string s.
...
assert remove_duplicates_set("banana") == "ban"
...
def gem_counting(stones, gems):
    """
    Counts how many characters in the string stones are also present 
    in the string gems.
    ...
    4
    Parameters:
    - stones (str): String representing collected stones.
    - gems (str): String representing gem types.
...
def students_id(ids):
    ...
    Parameters:
    - ids (list): list of student id strings

    Returns:
    - (int): number of different students
    """
    id_set = set(ids)
    return len(id_set)
...
def students_id_occurrences(ids):
    """
    Returns the number of occurrences of each student ID
    ...
    Returns:
    - (dict): dictionary with id as key and count as value
    """
    id_dict = {}
...
def word_frequency(paragraph):
    ...
    Returns:
    - (dict): dictionary with word as key and count as value
